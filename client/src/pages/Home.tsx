          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                Professional assessment tools, personalized wellness tips, and
                24/7 support—all in a safe, anonymous space designed for your
                peace of mind.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link href="/quiz">
                  <Button
                    size="lg"
                    className="rounded-full text-lg px-8 py-6 h-auto bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25"
                  >
            ...
            >
              <div className="relative">
                ...
                {/* Floating Card */}
                <div className="absolute -bottom-8 -left-8 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-xl border border-border animate-float z-20">
      ...
      <section className="section-padding bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container-width relative z-10 text-center">
          ...
          <p className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Join thousands of others who are prioritizing their mental health
          ...
          <Link href="/auth">
            <Button
              size="lg"
              variant="secondary"
              className="rounded-full text-lg px-8 py-6 h-auto shadow-xl hover:scale-105 transition-transform"
            >
